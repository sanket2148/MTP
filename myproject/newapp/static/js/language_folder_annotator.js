document.addEventListener('DOMContentLoaded', function() {
    document.querySelectorAll('.gallery-image[data-confidential="true"]').forEach(function(image) {
        image.addEventListener('contextmenu', function(e) {
            e.preventDefault(); // Prevent the context menu
            alert('Downloading confidential images is not allowed.'); // Optional: Show a message
        });
    });
});
